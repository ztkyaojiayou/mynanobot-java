...
#### 6.7.5 阶段四：AgentRunner —— LLM 调用 + 工具执行循环
...
#### 6.13.4 Context Window 与 Token 预算
...
---
### 6.17 MCP (Model Context Protocol) 系统

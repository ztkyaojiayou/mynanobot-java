...
ORIG_DIR="$PWD"
cd "$DIR" && java -Dloader.main=com.nanocode.v3.NanoCodeCliApplication -jar "$DIR/nanocode.jar" --workspace "$ORIG_DIR" "$@"
SCRIPT
...
@echo off
set DIR=%~dp0
java -Dloader.main=com.nanocode.v3.NanoCodeCliApplication -jar "%DIR%nanocode.jar" --workspace "%CD%" %*
BAT

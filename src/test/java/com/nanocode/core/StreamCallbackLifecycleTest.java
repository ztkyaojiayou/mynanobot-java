...
class StreamCallbackLifecycleTest {
    ...
    void setUp() {
        ...
        LLMProvider mockProvider = new LLMProvider() {
            ...
            @Override
            public java.util.concurrent.CompletableFuture<com.nanocode.providers.LLMResponse> chat(
                    List<com.nanocode.providers.LLMProvider.Message> msgs,
                    List<com.fasterxml.jackson.databind.JsonNode> tools) {
                return chatStream(msgs, tools, null);
            }

            @Override
            public java.util.concurrent.CompletableFuture<com.nanocode.providers.LLMResponse> chatStream(
                    List<com.nanocode.providers.LLMProvider.Message> msgs,
                    List<com.fasterxml.jackson.databind.JsonNode> tools,
